...
const CATEGORIES = [
  ...
  { icon: Amphora,      label: "Антики и колекции",         hints: "Монети · Картини · Военни предмети" },
  { icon: ShoppingBasket, label: "Храни и местни продукти", hints: "Мед · Сладка · Подправки · Ядки" },
